...
export default class Tools extends Component {
	...
	render(){
		...
		var style1 = {padding: "14px 0px 0px 0px", float: "left", margin : "0px 80px 0px 0px"}
		var style2 = {cursor: "pointer", display:"block" }
		var style3 = {cursor: "pointer", display:"none"}
		var style4 = {stroke:"rgb(255,255,255)", strokeWidth:100}
		var style5 = {color:"white"}
		var style6 = {textAlign:"center"}
		var style7 = {textAlign:"center", margin:"5px 0px 0px 0px", fontSize:"15px", display:"none" }
		var style8 = {textAlign:"center", margin:"5px 0px 0px 0px", fontSize:"15px"}
		var style9 = {textAlign:"center", margin:"5px 0px 0px 0px", fontSize:"15px", display:"block" }
		var style10 = {width:"46px",height:"46px",}
	
		return(
			<div id="plot-shapes" style={style1}>
				<a id="zoom-out" name="zoom-out" style={style2} onClick={this.props.ZoomOut}>
					<svg id="ssss" class= "test" viewBox="0 0 1000 1000" width="46px" height="46px">
				...
				</a>
				{
					...
					<a id="play" style={style2}>
						<svg class="test" viewBox="0 0 1300 1300" width="3em" height="3em" onClick={this.props.TogglePause}>
					...
					<a id="pause" style={style2}>
						<svg viewBox="0 0 1000 1000" class="test" width="46px" height="46px" onClick={this.props.TogglePause}>
				...
				<a id="dot" style={style2}>
					<svg class="test" viewBox="0 0 1000 1000" width="46px" height="46px" onClick= {this.props.ToggleDotMode}>
					<circle class= "test" cx="500" cy="500" r="500" stroke="black" strokeWidth="3" fill="black" onmouseover="evt.target.setAttribute('fill', '#38f');"
				...
				<a id="line" style={style3}>
					...
					<circle class="outer" cx="500" cy="500" r="500" stroke="black" strokeWidth="3" fill="black" onmouseover="evt.target.setAttribute('fill', '#38f');"
					onmouseout="evt.target.setAttribute('fill', 'black');"/>
				...
				<div class="circle" ref="avg" style={style8} onClick = {() =>{ this.props.ToggleAvgFlag(); if(this.refs.avg.style.backgroundColor == "rgb(0, 0, 255)")
					this.refs.avg.style.backgroundColor = "rgb(0, 0, 0)"
						else
							this.refs.avg.style.backgroundColor = "rgb(0, 0, 255)"
					;  }}  onDoubleClick = {() => {this.props.AVGNumSet()}}  >

					<span style={style5}>Avg </span>
				</div>

				<div class="circle" id="x_y" title="set marker" style={style8}>
					<span style={style5}>m</span>

				</div>

				<div class="circle" id="P-Detection" style={style7}>
