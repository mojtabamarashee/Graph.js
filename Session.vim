...
set sidescroll=1
set smartindent
set statusline=%<%F%h%m%r\ [%{&ff}]\ (%{strftime(\"%H:%M\ %d/%m/%Y\",getftime(expand(\"%:p\")))})%=%l,%c%V\ %P%#warningmsg#%{SyntasticStatuslineFlag()}%*
set noswapfile
